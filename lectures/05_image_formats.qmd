...
If that image had 24-bit color (web standard), it's file size would be:
...
::: {style="font-size: 50%"}
If you're interested in image compression, the Wikipedia page [Image compression](https://en.wikipedia.org/wiki/Image_compression) has a lot of detail.
...
You can also find the help page rendered on the web [here](https://stat.ethz.ch/R-manual/R-devel/library/grDevices/html/Devices.html).
...
[^3]: Note that RStudio has it's own graphics device

## R Graphical Devices

Additional graphical devices can be accessed through packages. I often use the AGG library through the package `ragg`  ([https://ragg.r-lib.org/](https://ragg.r-lib.org/)).
